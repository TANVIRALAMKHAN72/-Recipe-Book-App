...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="flex flex-col lg:flex-row items-center gap-8 bg-base-300 shadow-lg rounded-2xl p-6 w-full max-w-5xl">


        <div className="w-full lg:w-1/2 flex justify-center">
          <Lottie animationData={loginAnimation} loop={true} style={{ height: '400px', width: '400px' }} />
        </div>
